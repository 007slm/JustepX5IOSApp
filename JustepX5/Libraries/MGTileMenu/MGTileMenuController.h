...
@property (nonatomic,unsafe_unretained, readonly) UIView *parentView;
...
- (CGRect)frameForTileAtIndex:(NSInteger)tileNumber; // zero-based tileNumber, 0-5 (excludes central Close but ton position)
